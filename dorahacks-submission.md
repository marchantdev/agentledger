...
## Demo Video
~40-second walkthrough: value prop → verified receipt #119 (Northwind Cloud $8,500, Casper-RPC-verified) → tamper mismatch → verification. [hosted URL inserted at submission]
