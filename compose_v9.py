...
def main():
    ...
    a1 = os.path.join(ASSETS,"scene6_dispute_v9.mp3")
    imgs1 = [(img("v9_landing.png"),5.0),(img("v9_job_brief.png"),None)]
    o1 = os.path.join(VIDEO_DIR,"v9_dispute.mp4")
    ...
    a2 = os.path.join(ASSETS,"scene4_receipt_v9.mp3")
    imgs2 = [(img("v9_receipt.png"),7.0),(img("v9_receipt_verified.png"),None)]
    o2 = os.path.join(VIDEO_DIR,"v9_rcptscene.mp4")
    ...
    a3 = os.path.join(ASSETS,"scene5_tamper_v9.mp3")
    imgs3 = [(img("v9_tamper_comparison.png"),5.0),(img("v9_tampered.png"),None)]
    o3 = os.path.join(VIDEO_DIR,"v9_tamperscene.mp4")
    ...
    vi = img("v9_verified_card.png")
    o4 = os.path.join(VIDEO_DIR,"v9_verified_card.mp4")
    if vi:
    ...
    concat = os.path.join(VIDEO_DIR,"v9_concat.txt")
    with open(concat,"w") as f:
        for sf in scenes: f.write(f"file '{sf}'\n")
    final = os.path.join(VIDEO_DIR,"agentledger_demo_v9.mp4")
    r = subprocess.run([
