...
const SCENARIOS = [
  {
    ...
    icon: Briefcase,
    color: "#34d399",
    description: "Treasury agent reviews invoice against budget threshold, approves $8,500 payment to Acme Cloud.",
    ...
    policySteps: [
      { label: "Read invoice facts", detail: "INV-2026-1547 — Acme Cloud — $8,500 USDT" },
      { label: "Check budget threshold", detail: "Invoice $8,500 is 16% of remaining $52,000 budget (< 25% limit)" },
      { label: "Verify vendor approval", detail: "Acme Cloud — tier-1 approved vendor list" },
    ...
    decision: "APPROVED",
    riskScore: 0.14,
    reasoning: "Invoice $8,500 from Acme Cloud consumes 16% of remaining $52,000 budget. Below single-approval threshold. Vendor verified tier-1. Approved with high confidence.",
    seededDecisionId: 114,
  },
  {
    id: "defi_swap",
