...
const SCENARIOS = [
  {
    ...
    icon: Briefcase,
    color: "#34d399",
    description: "Treasury agent reviews invoice against budget threshold, approves $8,500 payment to Northwind Cloud.",
    agentId: "treasury-agent-01",
    policyVersion: "treasury-v2.1",
    inputFacts: {
      invoice_id: "INV-2026-1547",
      vendor: "Northwind Cloud",
      amount: 8500,
      currency: "USDT",
      budget_remaining: 52000,
    },
    policySteps: [
      { label: "Read invoice facts", detail: "INV-2026-1547 — Northwind Cloud — $8,500 USDT" },
      { label: "Check budget threshold", detail: "Invoice $8,500 is 16% of remaining $52,000 budget (< 25% limit)" },
      { label: "Verify vendor approval", detail: "Northwind Cloud — tier-1 approved vendor list" },
      { label: "Duplicate invoice check", detail: "No duplicate INV-2026-1547 in last 30 days" },
      { label: "Single-approval limit", detail: "$8,500 < $15,000 single-approval threshold" },
    ],
    decision: "APPROVED",
    riskScore: 0.14,
    reasoning: "Invoice $8,500 from Northwind Cloud consumes 16% of remaining $52,000 budget. Below single-approval threshold. Vendor verified tier-1. Approved with high confidence.",
    seededDecisionId: 119,
  },
  {
    id: "defi_swap",
  ...
  },
  {
    ...
    policySteps: [
      ...
      { label: "Check position exposure", detail: "$25,000 position above $8,500 minimum alert threshold" },
