#!/usr/bin/env node
// verify_receipt_119.js — Independently verify AgentLedger receipt #119 against Casper testnet.
// No dependencies (Node 18+).  Run:  node verify_receipt_119.js
const RPC = "https://node.testnet.casper.network/rpc";
const TX  = "c737ef8d221a58214cfc27e3ae7c9424df61e68ef1013419c49c31ed09846682";
const EXPECT = {
  ...
  input_hash: "d37fd3b41d5b9b723996ee573859976544cecb178a30bd3f373ee91fddb2c27e",
...
(async () => {
  ...
  console.log(`Receipt #119 — Casper testnet verification (tx ${TX.slice(0,16)}...)`);
  ...
  console.log(ok ? "\nVERIFIED: receipt #119 is a real, successful, contract-correct Casper decision attestation." : "\nFAILED: mismatch.");
  process.exit(ok ? 0 : 1);
